...
public class OrderControllerTest {
    ...
    public void testCreateOrder() {
        ...
        // Configure CartService.getCartById(...).
        ...
        // Run the test
        final String result = orderControllerUnderTest.createOrder(0);

        // Verify the results
        assertEquals("redirect:/checkout?cartId=0", result);
        verify(mockCustomerOrderService).addCustomerOrder(any(CustomerOrder.class));
    }
}
