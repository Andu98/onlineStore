...
public class CustomerOrderServiceImplTest {
    ...
    @Mock
    private CustomerOrderDao mockCustomerOrderDao;
    @Mock
    private CartService mockCartService;

    @InjectMocks
    private CustomerOrderServiceImpl customerOrderServiceImplUnderTest;
    ...
    public void testAddCustomerOrder() {
        ...
        customerOrderServiceImplUnderTest.addCustomerOrder(customerOrder);


        verify(mockCustomerOrderDao).addCustomerOrder(any(CustomerOrder.class));
    }

    @Test
    public void testGetCustomerOrderGrandTotal() {
        ...
        final double result = customerOrderServiceImplUnderTest.getCustomerOrderGrandTotal(0);
